package com.sentio.core_service.calendar.internal.model;

import static com.sentio.core_service.calendar.internal.HolidayConstants.NAME_LENGTH;
...
public class Holiday {
    ...
    // HolidayServiceImpl.findWorkingDayOverrides читають саме цей метод.
