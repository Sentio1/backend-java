package com.sentio.core_service.deadline.internal.controller;
...
public class DeadlineRuleController {
    ...
    // репозиторний запит з null-параметром повернув би хибний результат замість помилки -
    // краще одразу стандартне Spring "required parameter missing".
