...
public interface DeadlineRuleMapper {
    ...
    @Mapping(target = "courtInstance", ignore = true)
    @Mapping(target = "triggerEventCode", ignore = true)
    @Mapping(target = "durationValue", ignore = true)
    @Mapping(target = "durationUnit", ignore = true)
    @Mapping(target = "dayKind", ignore = true)
    @Mapping(target = "countFrom", ignore = true)
