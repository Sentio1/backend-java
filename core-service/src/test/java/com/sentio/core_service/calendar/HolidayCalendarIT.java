package com.sentio.core_service.calendar;
...
import com.sentio.core_service.calendar.internal.enums.HolidayType;
...
// SEN-26: HolidayCalendar на реальному core.holidays - і на сідингу 2026 року (V34), і на
...
class HolidayCalendarIT {
    ...
    void seed2026_newYearsDay_isNonWorking() {
        Map<LocalDate, Boolean> overrides = holidayCalendar.findWorkingDayOverrides(
    ...
    void findWorkingDayOverrides_dateNotInTable_isAbsentFromTheMap() {
        ...
        Map<LocalDate, Boolean> overrides = holidayCalendar.findWorkingDayOverrides(dec31, dec31, dec31);
    ...
    void findWorkingDayOverrides_rowAnnouncedInTheFuture_isExcluded_untilAsOfReachesEffectiveFrom() {
        ...
        Map<LocalDate, Boolean> beforeAnnouncement = holidayCalendar.findWorkingDayOverrides(
                transferredSaturday, transferredSaturday, announcedOn.minusDays(1));
        Map<LocalDate, Boolean> afterAnnouncement = holidayCalendar.findWorkingDayOverrides(
