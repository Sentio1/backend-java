...
// наскрізно, через реальний CaseServiceImpl.updateCase -> AuditLogService.log -> AuditLogRepository,
// а не лише юніт-тестом на сам AuditLogService (той перевіряє лише його власну логіку запису,
// не те, що CaseServiceImpl реально викликає його з правильними значеннями на реальній зміні поля).
