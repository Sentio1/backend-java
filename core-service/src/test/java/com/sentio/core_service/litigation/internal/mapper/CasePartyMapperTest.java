...
// Pure MapStruct, no Spring context: since the client relation became a plain clientId (the
// client itself is resolved through the client module's API), CasePartyMapperImpl has no injected
// collaborators anymore - earlier this test had to plant a ClientMapper mock via reflection.
