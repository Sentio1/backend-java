...
import static com.sentio.user_service.identity.auth.service.AuthService.INVALID_ERROR_MSG;
...
public class ServiceToken {
    ...
    public ServiceTokenResult serviceToken(ServiceTokenRequest request) {
        ...
        return new ServiceTokenResult(
                tokenIssuer.issueServiceAccessToken(user.getId()), "Bearer", jwtProperties.getAccessTokenExpiration());
    }
}
