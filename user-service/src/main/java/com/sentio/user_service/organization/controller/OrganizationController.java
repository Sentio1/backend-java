...
/**
 * The organization itself - creating a session in a different default org
 * (switch) and editing the organization's own fields. Membership management
 * lives in {@link OrganizationMemberController}, invites in
 * {@link OrganizationInviteController}.
 */
@RestController
...
public class OrganizationController {
    ...
    public ResponseEntity<UserContextResponse> switchOrganization(
        ...
        AuthResult authResult = organizationService.switchDefaultOrganization(user.getId(), orgId);
