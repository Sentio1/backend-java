...
class AuthControllerIT {
    ...
    void login_wrongPasswordAndUnknownEmail_return401WithIdenticalMessage() throws Exception {
        ...
        ErrorResponse wrongPasswordBody =
                objectMapper.readValue(wrongPassword.getResponse().getContentAsString(), ErrorResponse.class);
        ErrorResponse unknownEmailBody =
                objectMapper.readValue(unknownEmail.getResponse().getContentAsString(), ErrorResponse.class);
